...
export function DateRangeIcon({ size = 1 }) {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M7.288 13.713Q7 13.425 7 13t.288-.712T8 12t.713.288T9 13t-.288.713T8 14t-.712-.288m4 0Q11 13.426 11 13t.288-.712T12 12t.713.288T13 13t-.288.713T12 14t-.712-.288m4 0Q15 13.426 15 13t.288-.712T16 12t.713.288T17 13t-.288.713T16 14t-.712-.288M5 22q-.825 0-1.412-.587T3 20V6q0-.825.588-1.412T5 4h1V3q0-.425.288-.712T7 2t.713.288T8 3v1h8V3q0-.425.288-.712T17 2t.713.288T18 3v1h1q.825 0 1.413.588T21 6v14q0 .825-.587 1.413T19 22zm0-2h14V10H5zM5 8h14V6H5zm0 0V6z"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="m18 13l-1.375-6.874a1 1 0 0 0-.746-.776L3.235 2.028a1 1 0 0 0-1.207 1.207L5.35 15.879a1 1 0 0 0 .776.746L13 18M2.3 2.3l7.286 7.286" />
...
export function StethOscopeIcon({ size = 1 }) {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M13.464 21q-2.294 0-3.908-1.602T7.942 15.5v-.517q-1.9-.177-3.2-1.6q-1.3-1.421-1.3-3.383V4.5h3v-1h1v3h-1v-1h-2V10q0 1.65 1.175 2.825T8.442 14t2.825-1.175T12.442 10V5.5h-2v1h-1v-3h1v1h3V10q0 1.962-1.3 3.384t-3.2 1.599v.517q0 1.875 1.318 3.188Q11.58 20 13.463 20q1.875 0 3.187-1.312t1.313-3.188v-1.56q-.702-.165-1.159-.738t-.457-1.318q0-.88.618-1.498q.618-.617 1.5-.617t1.498.617t.615 1.499q0 .744-.457 1.317q-.456.573-1.158.739V15.5q0 2.296-1.602 3.898T13.464 21m5.787-8.326q.326-.326.326-.79q0-.463-.326-.789t-.79-.326t-.789.326t-.326.79t.326.789t.79.326t.789-.326m-.79-.79"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <g
        ...
        strokeWidth="1.5"
      >
        <path d="m11.966 20l-.004-8m7.863 5c4.495-3.16.475-7.73-3.706-7.73C13.296-1.732-3.265 7.368 4.074 15.662" />
        <path d="m15.144 14.318l-3.182-3.182l-3.182 3.182" />
      </g>
    </svg>
  );
}
...
export function GlobIcon({ size = 1 }) {
  return (
    ...
    >
      ...
      >
        <circle cx="12" cy="12" r="10" />
        <path d="M12 2a15 15 0 0 1 0 20a15 15 0 0 1 0-20m10 10H2" />
      </g>
    </svg>
  );
}
